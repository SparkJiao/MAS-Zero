...
Remember to combine it with the sub-task instruction to help the agent to explicitly avoid some trap, invalid cases, or terrible/too difficult options and include it in the following "code" entry.
